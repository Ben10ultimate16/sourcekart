...
<td><a href="ProductDesc/${product.productId}"><img src="<c:url value="/resources/${product.productId}.jpg"/> "width="50px" height="50px" />
</a>  </td>
<a style="padding-left:10px;class="btn btn-success btn-outline" href="<c:url value="/ProductDetail/${product.productId}"/>"><i class="fa fa-eye" aria-hidden="true" style="color:black;"></i></a></td>
